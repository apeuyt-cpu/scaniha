...
export default function OnboardingChecklist({ business }: { business: OnboardingBusiness }) {
  ...
  const steps: Step[] = useMemo(() => {
    ...
    if (mode === 'fidelity') {
      // Fidelity-only: no menu → no menu design/colours. The logo + name (la
      // marque) live in Réglages; the fidélité page keeps its own clean look.
      return [
        { ...logo, href: '/admin/settings' },
