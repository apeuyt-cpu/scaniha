...
/**
 * Toast system (v2 kit). Identical API to legacy ui/Toast — ToastProvider +
 * useToast() with success/error/info/toast — so re-homed components drop in
 * unchanged. Premium-light styling, brand-orange info dot.
 */
...
function ToastItem({ toast, onDismiss }: { toast: Toast; onDismiss: () => void }) {
  ...
  return (
    <div
      ...
      className={`pointer-events-auto flex w-full max-w-sm items-start gap-2.5 rounded-xl border px-4 py-3 text-sm font-medium shadow-soft-lg ${styles[toast.type]} animate-[toastIn_.2s_ease-out]`}
    >
