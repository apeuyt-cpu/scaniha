 ...
 */
export default function PoweredByScaniha({ liftForNav = false }: { liftForNav?: boolean }) {
  return (
    <a
      href="/"
      target="_blank"
      ...
      className={`fixed ${liftForNav ? 'bottom-[5.25rem]' : 'bottom-4'} left-4 z-30 flex h-9 w-9 items-center justify-center rounded-full border border-black/5 bg-white/90 shadow-lg shadow-black/10 backdrop-blur-md transition hover:-translate-y-0.5 hover:shadow-xl`}
    >
