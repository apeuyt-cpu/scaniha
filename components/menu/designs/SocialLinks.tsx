...
type Social = { label: string; url: string; color: string; icon: 'facebook' | 'instagram' | 'x' | 'whatsapp' | 'web' | 'google' }
...
export function getSocials(business: any): Social[] {
  ...
  const goo = socialUrl(business?.google_url)
  return [
    ...
    goo && { label: 'Google', url: goo, color: '#EA4335', icon: 'google' as const },
