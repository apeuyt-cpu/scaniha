  ...
  const blocks = [
    {
      ...
      disambiguatingDescription:
        'Scaniha est une application web tunisienne de création de menus QR (QR code) et de cartes numériques pour les restaurants, cafés et commerces alimentaires. Éditée par Rakiza Group.',
      knowsLanguage: 'fr',
