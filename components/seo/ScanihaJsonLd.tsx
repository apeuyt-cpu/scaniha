  ...
  const blocks = [
    {
      ...
      name: 'Scaniha',
      legalName: 'Scaniha',
      alternateName: ['Scaniha Menu QR', 'Scaniha QR Menu', 'QR Menu Platform', 'Scaniha QR Menu Platform', 'Digital Menu Builder'],
      ...
      description: 'Scaniha is a global QR menu platform for restaurant menus — digital QR-code menus for restaurants, cafés and food businesses worldwide. Créateur de menu QR pour restaurants et cafés.',
      disambiguatingDescription:
        'Scaniha is a QR menu platform and digital restaurant-menu software for restaurants, cafés and food businesses. Scaniha est une application web de création de menus QR (QR code) pour la restauration — une plateforme logicielle de menu QR. Éditée par Rakiza Group.',
      knowsLanguage: 'fr',
    ...
    },
    {
      ...
      name: 'Scaniha',
      url: 'https://scaniha.com',
      description: 'QR menu platform for restaurant menus — créateur de menu QR pour restaurants, cafés et commerces alimentaires.',
    ...
    },
    {
      ...
      name: 'Scaniha',
      alternateName: ['Scaniha Menu QR', 'QR Menu Platform', 'Digital Menu Builder'],
      description: 'Scaniha — the global QR menu platform for restaurant menus.',
      url: 'https://scaniha.com',
      inLanguage: 'fr',
